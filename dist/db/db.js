    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4, storage.set((0, keys_1.usersKey)(), JSON.stringify(users))];
                case 2:
                    _a.sent();
                    return [2];
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4, storage.get((0, keys_1.usersKey)())];
                case 2:
                    users = _a.sent();
                    return [2, users
                            ? JSON.parse(users)
...
function dbGetLastUser() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, dbGetUsers()];
                case 1:
                    users = _a.sent();
                    return [2, users.length > 0 ? users[0] : undefined];
            }
        });
    });
}
...
function dbGetWsUsers() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, dbGetUsers()];
                case 1: return [2, (_a.sent()).filter(function (user) { return user.type === nearpay_ts_sdk_1.NEARPAY_CONNECTOR.WS; })];
            }
        });
    });
}
