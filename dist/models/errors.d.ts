...
export declare enum PURCHASE_ERROR_ENUM {
...
export type PurchaseError = PurchaseDecielnd | PurchaseRejected | PurchaseAuthFailed | PurchaseInvalidStatus | PurchaseGeneralError;
export declare enum REFUND_ERROR_ENUM {
...
export type RefundError = RefundDecielnd | RefundRejected | RefundAuthFailed | RefundInvalidStatus | RefundGeneralError;
export declare enum REVERSE_ERROR_ENUM {
...
export type ReverseError = ReverseFailureMessage | ReverseAuthFailed | ReverseInvalidStatus | ReverseGeneralError;
export declare enum RECONCILE_ERROR_ENUM {
...
export type ReconcileError = ReconcileFailureMessage | ReconcileAuthFailed | ReconcileInvalidStatus | ReconcileGeneralError;
export declare enum SESSION_ERROR_ENUM {
...
export type SessionError = SessionFailureMessage | SessionAuthFailed | SessionInvalidStatus | SessionGeneralError;
export declare enum QUERY_ERROR_ENUM {
...
export type QueryError = QueryFailureMessage | QueryAuthFailed | QueryInvalidStatus | QueryGeneralError;
